...
insert  into `vendor_portfolio`(`portfolio_id`,`portfolio_name`,`portfolio_slug_name`,`portfolio_thumbnail`,`vendor_id`,`created_at`,`updated_at`,`deleted_at`) values (1,'Kebun Midplaza 1 & 2','kebun-midplaza-1---2',NULL,1,'2018-12-02 19:57:12','2018-12-02 19:59:05',NULL),(2,'Kebun Mercubuana','kebun-mercubuana',NULL,1,'2018-12-02 19:58:50','2018-12-02 19:58:50',NULL);
...
CREATE TABLE `vendor_portfolio_images` (
  ...
  `thumbnail` enum('N','Y') DEFAULT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime DEFAULT NULL,
  `deleted_at` datetime DEFAULT NULL,
