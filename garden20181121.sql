...
insert  into `kabupaten`(`id_kab`,`kode_kab`,`nama_kab`,`id_provinsi`) values (2,'JKT','Jakarta Timur',1),(1,'SRG','Serang',2),(3,'TNG','Tangerang',2);
...
insert  into `provinsi`(`id_provinsi`,`kode_provinsi`,`nama_provinsi`) values (2,'BTN','Banten'),(1,'DKI','DKI Jakarta');
