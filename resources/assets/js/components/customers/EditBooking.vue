    ...
    <div class="booking_container">
        ...
        <div class="uk-container">
          <div class="uk-card uk-card-body">
            <div class="uk-card-title booking_heading">
              Pesan Vendor - {{ booking.vendor_name }}
            </div>
      ...
      <div class="uk-card uk-card-body uk-card-default booking_formcontent">
        <div class="uk-container uk-card uk-card-body booking_bodyform">
          ...
          <form class="uk-form-stacked" @submit.prevent="onBookingUpdate">
              ...
              <div class="uk-width-1-3@xl uk-width-1-3@l uk-width-1-2@m uk-width-1-2@s">
                <div class="uk-card uk-card-default booking_gridbox">
                  ...
                  <div class="uk-margin">
                    ...
                    <input type="text" class="uk-width-1-1 uk-input booking_formaction" v-model="forms.price_deal" @keyup="formatPrice()" placeholder="Rp. " />
...
export default {
  ...
  methods: {
    ...
    onBookingUpdate() {
      ...
      axios.post( this.url + '/edit_booking/' + this.forms.transaction_id, formdata ).then( res => {
        var redirect = this.url + '/customers/main_orders/' + this.forms.transaction_id;
